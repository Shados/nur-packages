...
copas = callPackage({ binaryheap, buildLuarocksPackage, coxpcall, fetchFromGitHub, fetchurl, luaAtLeast, luaOlder, luasocket, timerwheel }:
buildLuarocksPackage {
  pname = "copas";
  version = "4.7.1-1";
  knownRockspec = (fetchurl {
  ...
  propagatedBuildInputs = [ binaryheap coxpcall luasocket timerwheel ];
...
etlua = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "etlua";
  version = "1.3.0-1";
  knownRockspec = (fetchurl {
...
inotify = callPackage({ buildLuarocksPackage, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "inotify";
  version = "0.5-1";
  knownRockspec = (fetchurl {
...
buildLuarocksPackage {
  ...
  disabled = luaOlder "5.1";
  propagatedBuildInputs = [ cmark lpeg optparse ];
...
lua-ev = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "lua-ev";
  version = "v1.5-1";
  knownRockspec = (fetchurl {
...
lua-filesize = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "lua-filesize";
  version = "0.1.1-1";
  knownRockspec = (fetchurl {
...
lua-testmore = callPackage({ buildLuarocksPackage, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "lua-testmore";
  version = "0.3.7-1";
  knownRockspec = (fetchurl {
...
luachild = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaOlder }:
buildLuarocksPackage {
  pname = "luachild";
  version = "0.1-2";
  knownRockspec = (fetchurl {
...
lub = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaAtLeast, luaOlder, luafilesystem }:
buildLuarocksPackage {
  pname = "lub";
  version = "1.1.0-1";
  knownRockspec = (fetchurl {
...
lunix = callPackage({ buildLuarocksPackage, fetchurl }:
buildLuarocksPackage {
  pname = "lunix";
  version = "20220331-1";
  knownRockspec = (fetchurl {
...
mobdebug = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaAtLeast, luaOlder, luasocket }:
buildLuarocksPackage {
  pname = "mobdebug";
  version = "0.80-1";
  knownRockspec = (fetchurl {
...
moonpick = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaOlder, moonscript }:
buildLuarocksPackage {
  pname = "moonpick";
  version = "0.8-1";
  knownRockspec = (fetchurl {
...
moonscript = callPackage({ alt-getopt, buildLuarocksPackage, fetchFromGitHub, fetchurl, lpeg, luaOlder, luafilesystem }:
buildLuarocksPackage {
  pname = "moonscript";
  version = "0.5.0-1";
  knownRockspec = (fetchurl {
  ...
  disabled = luaOlder "5.1";
  propagatedBuildInputs = [ alt-getopt lpeg luafilesystem ];
...
moor = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, inspect, linenoise, moonscript }:
buildLuarocksPackage {
  pname = "moor";
  version = "v5.0-1";
  knownRockspec = (fetchurl {
...
optparse = callPackage({ buildLuarocksPackage, fetchurl, fetchzip, luaAtLeast, luaOlder }:
buildLuarocksPackage {
  pname = "optparse";
  version = "1.5-2";
  knownRockspec = (fetchurl {
...
pegdebug = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, lpeg, luaOlder }:
buildLuarocksPackage {
  pname = "pegdebug";
  version = "0.41-1";
  knownRockspec = (fetchurl {
...
spawn = callPackage({ buildLuarocksPackage, fetchurl, fetchzip, luaAtLeast, luaOlder, lunix }:
buildLuarocksPackage {
  pname = "spawn";
  version = "0.1-0";
  knownRockspec = (fetchurl {
...
yaml = callPackage({ buildLuarocksPackage, fetchFromGitHub, fetchurl, luaAtLeast, luaOlder, lub }:
buildLuarocksPackage {
  pname = "yaml";
  version = "1.1.2-1";
  knownRockspec = (fetchurl {
